...
Here is a little script that creates a tab-delimited file of `-L` commands to be 
used to pick out collections of scaffolds whose summed lengths try to be just a bit over 

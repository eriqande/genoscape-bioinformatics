...
my $cut_site = "TGCA"; #let the user specify the cut site keyword (e.g. "TGCA" for the SbfI 6 bp cutter) 

my $b = 8; #let the user specify barcode length 
